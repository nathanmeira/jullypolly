...
class GameOver(object):   
    ...
    def blitConteudo(self):
        ...
        self.message_display('Morango(s) coletados: ' + str(self.jully.qtdMorango), 40, (122,122,122), (200)) 
        self.message_display('Cenoura(s) coletados: ' + str(self.jully.qtdCenoura), 40, (122,122,122), (230)) 
        self.message_display('Uva(s) coletados: ' + str(self.jully.qtdUva), 40, (122,122,122), (260)) 
        self.message_display('Hotdogs destruídos: ' + str(self.jully.qtdHotDog), 40, (122,122,122), (290))
